...
**这个项目选的是外部存储这条:** 把当下学到的东西存下来,用以对抗遗忘曲线 —— 不指望记住全部,只要求需要的时候能找回来。同时保留后续**扩展和修改**的余地:存进去的不是终稿,而是可以继续长的东西。
...
- **四、的版本控制** 才可能存在:git 管得了 markdown,管不了别人家的数据库
- **五、的 AI skill** 才可能直接读:脚本能遍历目录、能 grep、能读文件,不需要任何 API
